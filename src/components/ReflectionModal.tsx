...
export default function ReflectionModal({ isVisible, setIsVisible, placeId, itemName, startingReflection }: ReflectionModalProps) {
        ...
        <div className={styles.blur} onClick={e => setIsVisible(!isVisible)}>
          <div className={styles.container} onClick={e => e.stopPropagation()}>
            <div className={styles.header}>
              <h3>Reflection</h3>
              <MdClose className={styles.close} size="25px" onClick={e => setIsVisible(!isVisible)}/>
            </div>
      ...
      <div className={styles.blur} onClick={e => setCameraStatus(!cameraStatus)}>
        <div className={styles['camera-modal']} onClick={e => e.stopPropagation()}>
            <Camera
              ...
              onCameraStart={() => setIsVisible(!isVisible)}
            />
        </div>
      </div>
      }
